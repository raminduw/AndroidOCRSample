...
public final class CropImage {
   ...
   */
  public static void startPickImageActivity(@NonNull Activity activity,boolean isChooserNeed) {
    activity.startActivityForResult(
        getPickImageChooserIntent(activity,isChooserNeed), PICK_IMAGE_CHOOSER_REQUEST_CODE);
  }

  /**
   * Same as method but instead of
   ...
   */
  public static void startPickImageActivity(@NonNull Context context, @NonNull Fragment fragment, boolean isChooserNeed) {
    fragment.startActivityForResult(
        getPickImageChooserIntent(context,isChooserNeed), PICK_IMAGE_CHOOSER_REQUEST_CODE);
  }
   ...
   */
  public static Intent getPickImageChooserIntent(@NonNull Context context,boolean isChooserNeed) {
    return getPickImageChooserIntent(
        context, context.getString(R.string.pick_image_intent_chooser_title), false, true,isChooserNeed);
  }
  ...
  public static Intent getPickImageChooserIntent(
      ...
      boolean includeCamera,boolean isChooserNeed) {
  ...
  public static final class ActivityBuilder {
    ...
    public Intent getIntent(@NonNull Context context,boolean isChooserNeed) {
      return getIntent(context, CropImageActivity.class,isChooserNeed);
    }

    /** Get {@link CropImageActivity} intent to start the activity. */
    public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls,boolean isChooserNeed) {
      mOptions.validate();
      ...
      intent.putExtra("NEED_CHOOSER", isChooserNeed);
      return intent;
    }
     ...
     */
    public void start(@NonNull Activity activity ,boolean isChooserNeed) {
      mOptions.validate();
      activity.startActivityForResult(getIntent(activity,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
     ...
     * @param activity activity to receive result
     */
    public void start(@NonNull Activity activity, @Nullable Class<?> cls,boolean isChooserNeed) {
      mOptions.validate();
      activity.startActivityForResult(getIntent(activity, cls,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
     ...
     */
    public void start(@NonNull Context context, @NonNull Fragment fragment,boolean isChooserNeed) {
      fragment.startActivityForResult(getIntent(context,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
  ...
  /*  @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public void start(@NonNull Context context, @NonNull android.app.Fragment fragment,boolean isChooserNeed) {
      fragment.startActivityForResult(getIntent(context,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }*/
     ...
     */
    public void start(
        @NonNull Context context, @NonNull Fragment fragment, @Nullable Class<?> cls,boolean isChooserNeed) {
      fragment.startActivityForResult(getIntent(context, cls,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }
...
/*    @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public void start(
        @NonNull Context context, @NonNull android.app.Fragment fragment, @Nullable Class<?> cls,boolean isChooserNeed) {
      fragment.startActivityForResult(getIntent(context, cls,isChooserNeed), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }*/
